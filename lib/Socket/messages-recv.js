                ...
                case 'message': {
                    ...
                    if (plaintextNode?.content) {
                        try {
                            ...
                            // Release raw buffer immediately after decode — large newsletter
                            // media payloads stay referenced until the handler returns otherwise
                            plaintextNode.content = null;
                            ...
                            // Null the message payload so GC can collect the proto object
                            // immediately instead of waiting for the handler scope to exit
